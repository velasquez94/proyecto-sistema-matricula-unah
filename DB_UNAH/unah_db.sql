...
-- Tiempo de generación: 05-05-2018 a las 23:33:46
...
INSERT INTO `tbl_alumnos` (`codigo_alumno`, `numero_cuenta`, `promedio`, `codigo_persona`) VALUES
(1, '20121002409', 80, 1);
...
(1, 'IS-410', 'Programación orientada a objetos ', 5, 'lunes, martes, miércoles, jueves y viernes', 1, 3),
(2, 'MM-111', 'Geometría y trigonométrica', 5, 'lunes, martes, miércoles, jueves y viernes', 1, 1),
(3, 'IS-310', 'Algoritmos y estructura de datos ', 4, 'lu, ma, mi, ju', 1, 3);
...
(1, 'IS', 'Ingeniería en sistemas ', 56, 224, 1, 1);
...
INSERT INTO `tbl_empleados` (`codigo_empleado`, `numero_empleado`, `sueldo_base`, `codigo_persona`, `codigo_tipo_empleado`, `codigo_cargo`) VALUES
(1, 100, 30000, 2, 1, 3),
(2, 101, 25000, 3, 2, 2),
(4, 102, 20000, 1, 2, 4);
...
(1, 'Francisco Morazan', NULL, NULL, 1, 1);
...
INSERT INTO `tbl_maestros` (`codigo_maestro`, `codigo_empleado`, `codigo_especializacion`, `codigo_titularidad`) VALUES
(1, 4, 1, 1),
(2, 2, 2, 2);
...
(1, 'primer periodo', '2018-01-22', '2018-05-17', 1),
(2, 'segundo periodo', '2018-06-05', '2018-09-03', 2),
(3, 'tercer periodo', '2018-09-09', '2018-12-20', 1);
...
INSERT INTO `tbl_personas` (`codigo_persona`, `nombre`, `apellido`, `fecha_nacimiento`, `identidad`, `direccion`, `telefono`, `correo_electronico`, `codigo_genero`, `codigo_tipo_identificacion`, `codigo_estado_civil`, `codigo_lugar_nacimiento`, `codigo_lugar_residencia`, `codigo_campus`) VALUES
(1, 'Carlos Roberto', 'Vasquez Rodrigez', '1994-05-01', '0801199408244', 'Colonia loarque ', '22268039', 'carlosrodriguez@gmail.com', 1, 1, 1, 1, 1, 1),
(2, 'Jose Alfredo', 'Gonzales Matute', '1990-10-10', '0801199028475', 'Colonia El pedregal', '98237481', 'josematute@gmail.com', 1, 1, 2, 1, 1, 1),
(3, 'Claudia Mariela', 'Izaguirre Mendoza', '1988-08-09', '0801198809672', 'Colonia Reynel funez', '98304876', 'claudiamendoza@gmail.com', 2, 1, 2, 1, 1, 1);
...
(1, '1500', '2018-02-20 15:00:00', '2018-02-20 16:00:00', 'lu, ma, mi, ju, vi', 40, 1, 1, 1, 1);
